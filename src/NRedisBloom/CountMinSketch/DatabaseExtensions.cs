...
namespace NRedisBloom.CountMinSketch
{
    ...
    public static partial class DatabaseExtensions
    {
        ...
        public static bool CountMinSketchInitByDim(this IDatabase db, string key, long width, long depth)
        {
            var result = db.Execute(Command.InitByDim, key, width, depth);
        ...
        /// <returns><code>true</code> if count-min sketch is initialized</returns>
        public static bool CountMinSketchInitByProb(this IDatabase db, string key, double error, double probability)
        {
            var result = db.Execute(Command.InitByProb, key, error, probability);
        ...
        public static long CountMinSketchIncrBy(this IDatabase db, string key, string item, long increment)
        {
            var result = db.Execute(Command.IncrBy, key, item, increment);
        ...
        public static long[] CountMinSketchIncrBy(this IDatabase db, string key,
            IDictionary<string, long> itemIncrements)
        {
            ...
            var result = db.Execute(Command.IncrBy, args);
        ...
        public static long[] CountMinSketchQuery(this IDatabase db, string key, params string[] items)
        {
        ...
        public static bool CountMinSketchMerge(this IDatabase db, string dest, params string[] keys)
        {
            var args = new List<object> {dest, keys.Length};
            args.AddRange(keys);

            var result = db.Execute(Command.Merge, args);
        ...
        /// <returns><code>true</code> on success</returns>
        public static bool CountMinSketchMerge(this IDatabase db, string dest,
        ...
        public static InfoResult CountMinSketchInfo(this IDatabase db, string key)
        {
